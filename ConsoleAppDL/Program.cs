...
namespace ConsoleAppDL
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string conn = "Data Source=.;Initial Catalog=Hotel;Integrated Security=True";
            ...
            c.AddMember(new Customer("paul", new DateOnly(2000, 5, 8)));
            c.AddMember(new Customer("rudy",new DateOnly(1987,1,1)));
            repo.AddCustomer(c);
